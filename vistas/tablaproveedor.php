                       ...
                       while ($row = mysqli_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="../modelos/edit_proveedor.php?id=<?php echo $row['id']?>" class="btn btn-dark">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ¿Está seguro que quiere eliminar el Proveedor?
                                                    </div>
                                                    <div class="modal-footer">
                                                    <a href="../modelos/delete_proveedor.php?id=<?php echo $row['id']?>" class="btn btn-danger btn-block">ELIMINAR<i class="fas fa-trash"></i></i>
