                                                ...
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ¿Está seguro que quiere eliminar el permiso?
                                                    </div>
                                                    <div class="modal-footer">
                                                    <a href="../modelos/delete_permiso.php?id=<?php echo $row['id']?>" class="btn btn-danger btn-block">ELIMINAR<i class="fas fa-trash"></i></i>
