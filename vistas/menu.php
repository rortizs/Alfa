            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLayouts"
                            aria-expanded="false" aria-controls="collapseLayouts">
                            <i class="fas fa-briefcase"></i>Producto
                            <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="../vistas/crearproductos.html"><i class="fas fa-wallet"></i>Crear
                                    Producto</a><a class="nav-link" href="../vistas/tablaproducto.php"><i class="fas fa-table"></i>Tabla Producto</a>
                            </nav>
                        </div>
                    </div>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <br></br>
                    <div align="center"><img src="../public/assets/img/foto1.jpeg" style="width:621px;height:567px;">
                    </div>
                    <br></br>
                    <img src="../public/assets/img/foto2.jpeg" align="left" style="width:576px;height:1024px;">
                </div>
                <div align="center"><img src="../public/assets/img/foto5.jpeg" style="width:576px;height:1024px;"></div>
                <br></br>
                <div align="center"><img src="../public/assets/img/foto3.jpeg" style="width:1024px;height:763px;"></div>
                <br></br>
                <div align="center"><img src="../public/assets/img/foto8.jpeg" style="width:700px;height:934px;"></div>
                <br></br>
