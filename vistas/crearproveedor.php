        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="sb-sidenav-menu-heading">Crear Proveedores</div>
            ...
            <div id="layoutSidenav_content">
                <main>
                  ...
                  <h4 class="mb-3">Ingresar datos para la creacion del Proveedor</h4>
                      ...
                      <div class="col-md-6 mb-3">
                       ...
                       Se requiere un número de documento válido.
                                                    ...
                                                    <label for="direccion" class="control-label">Dirección</label>
                                                           ...
                                                           placeholder="Eje. Ciudad" autofocus>
                                                    </div> 
                                                    ...
                                                    <label for="email" class="control-label">Email</label>
                                                           ...
                                                           placeholder="ejemplo@gmail.com" autofocus>
                                                    </div> 
                                                         ...
                                                         name="save_proveedor" value="Guardar">
                                                  </form>
