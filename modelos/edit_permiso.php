...
?>
      ...
      <form action="edit_permiso_proceso.php?id=<?php echo $_GET['id']; ?>" method="POST">
        
      <div class="form-group">
                                                  <i class="fas fa-clipboard-check"></i>
                                                    <label for="nombre_permiso" class="control-label">Nombre del Permiso</label>
                                                    <input type="text" name="nombre_permiso" class="form-control" placeholder=""
                                                        autofocus value="<?php echo $nombre_permiso; ?>">
                                                </div>
